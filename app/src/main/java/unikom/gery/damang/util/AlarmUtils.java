...
public class AlarmUtils {
     ...
     * @return
     */
    public static unikom.gery.damang.model.Alarm createSingleShot(int index, boolean smartWakeup, boolean snooze, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(unikom.gery.damang.model.Alarm alarm) {
