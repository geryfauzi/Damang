...
package unikom.gery.damang.service.devices.pinetime;
...
import unikom.gery.damang.devices.pinetime.PineTimeDFUService;
import unikom.gery.damang.devices.pinetime.PineTimeInstallHandler;
import unikom.gery.damang.devices.pinetime.PineTimeJFConstants;
...
public class PineTimeJFSupport extends AbstractBTLEDeviceSupport implements DfuLogListener {
        ...
        IntentListener mListener = new IntentListener() {
            ...
            public void notify(Intent intent) {
                ...
                if (DeviceInfoProfile.ACTION_DEVICE_INFO.equals(action)) {
                    ...
                    handleBatteryInfo((unikom.gery.damang.service.btle.profiles.battery.BatteryInfo) intent.getParcelableExtra(BatteryInfoProfile.EXTRA_BATTERY_INFO));
                }
            }
        };
    ...
    private void handleBatteryInfo(unikom.gery.damang.service.btle.profiles.battery.BatteryInfo info) {
    ...
    public void onNotification(NotificationSpec notificationSpec) {
        ...
        if (isFirmwareAtLeastVersion0_15()) {
            String senderOrTitle = unikom.gery.damang.util.StringUtils.getFirstOf(notificationSpec.sender, notificationSpec.title);
    ...
    private void handleDeviceInfo(unikom.gery.damang.service.btle.profiles.deviceinfo.DeviceInfo info) {
