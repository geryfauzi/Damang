...
import unikom.gery.damang.devices.huami.ActivateDisplayOnLift;
import unikom.gery.damang.devices.huami.DisconnectNotificationSetting;
...
import unikom.gery.damang.devices.huami.HuamiService;
import unikom.gery.damang.devices.huami.HuamiWeatherConditions;
import unikom.gery.damang.devices.huami.amazfitbip.AmazfitBipService;
import unikom.gery.damang.devices.huami.miband2.MiBand2FWHelper;
import unikom.gery.damang.devices.huami.miband3.MiBand3Coordinator;
import unikom.gery.damang.devices.huami.miband3.MiBand3Service;
import unikom.gery.damang.devices.miband.DateTimeDisplay;
import unikom.gery.damang.devices.miband.DoNotDisturb;
import unikom.gery.damang.devices.miband.MiBand2SampleProvider;
...
import unikom.gery.damang.model.CalendarEvents;
...
import unikom.gery.damang.service.btle.actions.AbortTransactionAction;
import unikom.gery.damang.service.btle.actions.ConditionalWriteAction;
import unikom.gery.damang.service.btle.actions.SetDeviceStateAction;
...
import unikom.gery.damang.service.btle.profiles.deviceinfo.DeviceInfoProfile;
import unikom.gery.damang.service.devices.common.SimpleNotification;
import unikom.gery.damang.service.devices.huami.actions.StopNotificationAction;
import unikom.gery.damang.service.devices.huami.miband2.Mi2NotificationStrategy;
import unikom.gery.damang.service.devices.huami.miband2.Mi2TextNotificationStrategy;
import unikom.gery.damang.service.devices.huami.operations.FetchActivityOperation;
import unikom.gery.damang.service.devices.huami.operations.InitOperation;
...
import static unikom.gery.damang.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_ALLOW_HIGH_MTU;
...
import static unikom.gery.damang.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_RESERVER_ALARMS_CALENDAR;
import static unikom.gery.damang.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SOUNDS;
import static unikom.gery.damang.activities.devicesettings.DeviceSettingsPreferenceConst.PREF_SYNC_CALENDAR;
...
import static unikom.gery.damang.devices.huami.HuamiConst.PREF_BUTTON_ACTION_SELECTION_BROADCAST;
import static unikom.gery.damang.devices.huami.HuamiConst.PREF_BUTTON_ACTION_SELECTION_OFF;
...
import static unikom.gery.damang.devices.huami.HuamiService.DISPLAY_ITEM_BIT_CLOCK;
import static unikom.gery.damang.devices.huami.HuamiService.ENDPOINT_DISPLAY_ITEMS;
import static unikom.gery.damang.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static unikom.gery.damang.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static unikom.gery.damang.devices.miband.MiBandConst.VIBRATION_COUNT;
import static unikom.gery.damang.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static unikom.gery.damang.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static unikom.gery.damang.devices.miband.MiBandConst.getNotificationPrefStringValue;
import static unikom.gery.damang.service.btle.GattCharacteristic.UUID_CHARACTERISTIC_ALERT_LEVEL;
    ...
    private final IntentListener mListener = new IntentListener() {
        ...
        public void notify(Intent intent) {
            ...
            if (DeviceInfoProfile.ACTION_DEVICE_INFO.equals(s)) {
                handleDeviceInfo((unikom.gery.damang.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
...
//        byte[] tail = new byte[] { 0x2 }; // reason
    ...
    private void decodeAndUpdateAlarmStatus(byte[] response) {
        List<unikom.gery.damang.entities.Alarm> alarms = DBHelper.getAlarms(gbDevice);
        int maxAlarms = 10;
        ...
        for (unikom.gery.damang.entities.Alarm alarm : alarms) {
