...
package unikom.gery.damang.service.devices.id115;
...
import unikom.gery.damang.devices.id115.ID115Constants;
import unikom.gery.damang.devices.id115.ID115SampleProvider;
