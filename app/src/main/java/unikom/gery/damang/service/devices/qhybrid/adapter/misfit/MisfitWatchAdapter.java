...
package unikom.gery.damang.service.devices.qhybrid.adapter.misfit;
...
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.ActivityPointGetRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.AnimationRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.BatteryLevelRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.DownloadFileRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.EraseFileRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.FileRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.GetCountdownSettingsRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.GetCurrentStepCountRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.GetStepGoalRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.GetVibrationStrengthRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.GoalTrackingGetRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.ListFilesRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.MoveHandsRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.OTAEnterRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.OTAEraseRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.PlayNotificationRequest;
...
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.SetCurrentStepCountRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.SetStepGoalRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.SetTimeRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.SetVibrationStrengthRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.UploadFileRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.VibrateRequest;
import unikom.gery.damang.util.FileUtils;
import unikom.gery.damang.util.GB;

import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.ITEM_ACTIVITY_POINT;
import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.ITEM_STEP_COUNT;
...
import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_FILE_UPLOADED;
