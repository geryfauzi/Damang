...
package unikom.gery.damang.service.devices.qhybrid.adapter.fossil;
...
import unikom.gery.damang.devices.qhybrid.NotificationConfiguration;
import unikom.gery.damang.devices.qhybrid.PackageConfigHelper;
...
import unikom.gery.damang.service.devices.qhybrid.adapter.WatchAdapter;
import unikom.gery.damang.service.devices.qhybrid.buttonconfig.ConfigFileBuilder;
import unikom.gery.damang.service.devices.qhybrid.buttonconfig.ConfigPayload;
...
import unikom.gery.damang.service.devices.qhybrid.requests.Request;
...
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.alarm.AlarmsSetRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.configuration.ConfigurationPutRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.device_info.DeviceInfo;
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.device_info.DeviceSecurityVersionInfo;
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.device_info.GetDeviceInfoRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.device_info.SupportedFileVersionsInfo;
...
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.file.FirmwareFilePutRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.notification.NotificationFilterPutRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.fossil.notification.PlayTextNotificationRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.AnimationRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.MoveHandsRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.ReleaseHandsControlRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.RequestHandControlRequest;
import unikom.gery.damang.service.devices.qhybrid.requests.misfit.SaveCalibrationRequest;
import unikom.gery.damang.util.FileUtils;
import unikom.gery.damang.util.GB;
import unikom.gery.damang.util.UriHelper;

import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.ITEM_STEP_GOAL;
import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.ITEM_TIMEZONE_OFFSET;
import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.ITEM_VIBRATION_STRENGTH;
import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_BUTTON_PRESS;
import static unikom.gery.damang.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_MULTI_BUTTON_PRESS;
...
public class FossilWatchAdapter extends WatchAdapter {
    ...
    public void vibrate(unikom.gery.damang.service.devices.qhybrid.requests.misfit.PlayNotificationRequest.VibrationType vibration) {
    ...
    public void onSetAlarms(ArrayList<? extends Alarm> alarms) {
        ...
        ArrayList<unikom.gery.damang.service.devices.qhybrid.requests.fossil.alarm.Alarm> activeAlarms = new ArrayList<>();
        for (Alarm alarm : alarms) {
            if (!alarm.getEnabled()) continue;
            if (alarm.getRepetition() == 0) {
                activeAlarms.add(new unikom.gery.damang.service.devices.qhybrid.requests.fossil.alarm.Alarm(
        ...
        queueWrite(new AlarmsSetRequest(activeAlarms.toArray(new unikom.gery.damang.service.devices.qhybrid.requests.fossil.alarm.Alarm[0]), this) {
            @Override
            public void onFilePut(boolean success) {
                super.onFilePut(success);
