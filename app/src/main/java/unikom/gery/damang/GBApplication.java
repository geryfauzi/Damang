...
import unikom.gery.damang.database.DBOpenHelper;
import unikom.gery.damang.devices.DeviceManager;
import unikom.gery.damang.entities.DaoMaster;
import unikom.gery.damang.entities.DaoSession;
import unikom.gery.damang.entities.Device;
import unikom.gery.damang.externalevents.BluetoothStateChangeReceiver;
...
import unikom.gery.damang.service.NotificationCollectorMonitorService;
...
import unikom.gery.damang.util.LimitedQueue;
import unikom.gery.damang.util.Prefs;

import static unikom.gery.damang.model.DeviceType.AMAZFITBIP;
import static unikom.gery.damang.model.DeviceType.AMAZFITCOR;
import static unikom.gery.damang.model.DeviceType.AMAZFITCOR2;
import static unikom.gery.damang.model.DeviceType.MIBAND;
import static unikom.gery.damang.model.DeviceType.MIBAND2;
import static unikom.gery.damang.model.DeviceType.MIBAND3;
import static unikom.gery.damang.model.DeviceType.PEBBLE;
import static unikom.gery.damang.model.DeviceType.fromKey;
