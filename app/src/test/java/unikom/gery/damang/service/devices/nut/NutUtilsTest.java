/*  Copyright (C) 2020 Taavi Eomäe
    ...
    */
package unikom.gery.damang.service.devices.nut;
...
import static unikom.gery.damang.devices.nut.NutKey.byteArraysConcatReverseWithPad;
import static unikom.gery.damang.devices.nut.NutKey.byteArraysDeConcatReverseWithPad;
import static unikom.gery.damang.devices.nut.NutKey.bytesToHex2;
import static unikom.gery.damang.devices.nut.NutKey.hexStringToByteArrayNut;
import static unikom.gery.damang.devices.nut.NutKey.macAsByteArray;
import static unikom.gery.damang.devices.nut.NutKey.passwordGeneration;
import static unikom.gery.damang.devices.nut.NutKey.reversePasswordGeneration;
