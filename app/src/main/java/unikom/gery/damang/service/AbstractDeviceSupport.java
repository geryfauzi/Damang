...
import unikom.gery.damang.activities.FindPhoneActivity;
import unikom.gery.damang.activities.appmanager.AbstractAppManagerFragment;
import unikom.gery.damang.database.DBAccess;
import unikom.gery.damang.database.DBHandler;
import unikom.gery.damang.database.DBHelper;
import unikom.gery.damang.deviceevents.GBDeviceEvent;
import unikom.gery.damang.deviceevents.GBDeviceEventAppInfo;
...
import unikom.gery.damang.deviceevents.GBDeviceEventDisplayMessage;
import unikom.gery.damang.deviceevents.GBDeviceEventFindPhone;
import unikom.gery.damang.deviceevents.GBDeviceEventFmFrequency;
import unikom.gery.damang.deviceevents.GBDeviceEventLEDColor;
import unikom.gery.damang.deviceevents.GBDeviceEventMusicControl;
import unikom.gery.damang.deviceevents.GBDeviceEventNotificationControl;
...
import unikom.gery.damang.entities.BatteryLevel;
...
import unikom.gery.damang.service.receivers.GBCallControlReceiver;
import unikom.gery.damang.service.receivers.GBMusicControlReceiver;
import unikom.gery.damang.util.GB;

import static unikom.gery.damang.util.GB.NOTIFICATION_CHANNEL_HIGH_PRIORITY_ID;
import static unikom.gery.damang.util.GB.NOTIFICATION_CHANNEL_ID;
